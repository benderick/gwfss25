...
def add_maskformer2_config(cfg):
    ...
    cfg.MODEL.TOPOWHEAT.TRPL.SUPPORT_PERSISTENCE = 0.5
    ...
    cfg.MODEL.TOPOWHEAT.TRPL.STEM_SUPPORT_RADIUS = 2
    cfg.MODEL.TOPOWHEAT.TRPL.STEM_SUPPORT_MIN_PROBABILITY = 0.15
    cfg.MODEL.TOPOWHEAT.TRPL.STEM_SUPPORT_PROBABILITY_FLOOR = 0.55
    cfg.MODEL.TOPOWHEAT.TRPL.CORE_ERODE_ITERATIONS = 2
    cfg.MODEL.TOPOWHEAT.TRPL.CORE_STEM_RADIUS = 1
    cfg.MODEL.TOPOWHEAT.TRPL.START_ITER = 0
    cfg.MODEL.TOPOWHEAT.TRPL.RAMP_ITERS = 5000
    cfg.MODEL.TOPOWHEAT.TRPL.CLASS_BALANCED_NLL = True
    cfg.MODEL.TOPOWHEAT.TRPL.MIN_CLASS_PIXELS = 32
    cfg.MODEL.TOPOWHEAT.TRPL.REGION_LOSS_WEIGHT = 1.0
    cfg.MODEL.TOPOWHEAT.TRPL.DICE_LOSS_WEIGHT = 0.5
    cfg.MODEL.TOPOWHEAT.TRPL.BOUNDARY_DISTILLATION_WEIGHT = 0.25
    cfg.MODEL.TOPOWHEAT.TRPL.TOPOLOGY_LOSS_WEIGHT = 0.5
    cfg.MODEL.TOPOWHEAT.TRPL.SKELETON_LOSS_WEIGHT = 0.10
    cfg.MODEL.TOPOWHEAT.TRPL.STEM_SUPPORT_LOSS_WEIGHT = 0.25
    cfg.MODEL.TOPOWHEAT.TRPL.SUPERVISED_REGION_WEIGHT = 0.25
    cfg.MODEL.TOPOWHEAT.TRPL.SUPERVISED_DICE_WEIGHT = 0.5
    cfg.MODEL.TOPOWHEAT.TRPL.SUPERVISED_TOPOLOGY_WEIGHT = 0.2
    cfg.MODEL.TOPOWHEAT.TRPL.LEGACY_QUERY_LOSS_WEIGHT = 0.05
