...
def add_maskformer2_config(cfg):
    ...
    cfg.MODEL.TOPOWHEAT.TRPL.VIEW_SCALE = 0.875
    cfg.MODEL.TOPOWHEAT.TRPL.RELIABILITY_THRESHOLD = 0.75
    cfg.MODEL.TOPOWHEAT.TRPL.TOPOLOGY_WEIGHT = 0.5
    cfg.MODEL.TOPOWHEAT.TRPL.RAMP_ITERS = 5000

    cfg.MODEL.TOPOWHEAT.TCPM = CN()
    cfg.MODEL.TOPOWHEAT.TCPM.ENABLED = False
    cfg.MODEL.TOPOWHEAT.TCPM.NUM_DOMAINS = 9
    cfg.MODEL.TOPOWHEAT.TCPM.LABELED_MOMENTUM = 0.95
    cfg.MODEL.TOPOWHEAT.TCPM.PSEUDO_MOMENTUM = 0.995
    cfg.MODEL.TOPOWHEAT.TCPM.PSEUDO_BLEND_MAX = 0.20
    cfg.MODEL.TOPOWHEAT.TCPM.TEMPERATURE = 0.3
    cfg.MODEL.TOPOWHEAT.TCPM.MAX_SAMPLES_PER_CLASS = 256
    cfg.MODEL.TOPOWHEAT.TCPM.MAX_QUERY_PIXELS_PER_CLASS = 128
    cfg.MODEL.TOPOWHEAT.TCPM.MIN_CORE_PIXELS = 4
    cfg.MODEL.TOPOWHEAT.TCPM.PSEUDO_MIN_WEIGHT = 0.50
    cfg.MODEL.TOPOWHEAT.TCPM.PSEUDO_MIN_CONFIDENCE = 0.80
    cfg.MODEL.TOPOWHEAT.TCPM.QUERY_MIN_WEIGHT = 0.25
    cfg.MODEL.TOPOWHEAT.TCPM.CORE_STRATEGY = "topology"
    cfg.MODEL.TOPOWHEAT.TCPM.SKELETON_ITERATIONS = 20
    cfg.MODEL.TOPOWHEAT.TCPM.CORE_ERODE_ITERATIONS = 2
    cfg.MODEL.TOPOWHEAT.TCPM.CORE_STEM_RADIUS = 1
    cfg.MODEL.TOPOWHEAT.TCPM.QUERY_MODE = "hard_region"
    cfg.MODEL.TOPOWHEAT.TCPM.HARD_QUERY_FRACTION = 0.25
    cfg.MODEL.TOPOWHEAT.TCPM.ALIGNMENT_TOLERANCE = 0.05
    cfg.MODEL.TOPOWHEAT.TCPM.START_ITER = -1
    cfg.MODEL.TOPOWHEAT.TCPM.MEMORY_WARMUP_ITERS = 5000
    cfg.MODEL.TOPOWHEAT.TCPM.LOSS_RAMP_ITERS = 10000
    cfg.MODEL.TOPOWHEAT.TCPM.PSEUDO_UPDATE_START = -1
    cfg.MODEL.TOPOWHEAT.TCPM.PSEUDO_RAMP_ITERS = 10000
    cfg.MODEL.TOPOWHEAT.TCPM.LEAVE_ONE_DOMAIN_OUT = True
    cfg.MODEL.TOPOWHEAT.TCPM.CONTRASTIVE_WEIGHT = 0.05
    cfg.MODEL.TOPOWHEAT.TCPM.DOMAIN_COMPACT_WEIGHT = 0.05
    cfg.MODEL.TOPOWHEAT.TCPM.HARD_NEGATIVE_WEIGHT = 0.02
