...
def add_maskformer2_config(cfg):
    ...
    cfg.MODEL.TOPOWHEAT.TCPM.MIN_CORE_PIXELS = 8
    ...
    cfg.MODEL.TOPOWHEAT.TCPM.CONTRASTIVE_WEIGHT = 0.02
    cfg.MODEL.TOPOWHEAT.TCPM.DOMAIN_COMPACT_WEIGHT = 0.01
    cfg.MODEL.TOPOWHEAT.TCPM.HARD_NEGATIVE_WEIGHT = 0.005
    cfg.MODEL.TOPOWHEAT.TCPM.HARD_NEGATIVE_MARGIN = 0.1
