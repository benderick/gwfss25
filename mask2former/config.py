...
def add_maskformer2_config(cfg):
    ...
    cfg.MODEL.TOPOWHEAT.TRPL.PERSISTENCE = 1.0
    cfg.MODEL.TOPOWHEAT.TRPL.SKELETON_ITERATIONS = 20
    cfg.MODEL.TOPOWHEAT.TRPL.SKELETON_MATCH_RADIUS = 1
    cfg.MODEL.TOPOWHEAT.TRPL.BOUNDARY_RADIUS = 2
    cfg.MODEL.TOPOWHEAT.TRPL.BOUNDARY_MIN_STEM_PROBABILITY = 0.20
    cfg.MODEL.TOPOWHEAT.TRPL.CENTERLINE_TOLERANCE_RADIUS = 1
